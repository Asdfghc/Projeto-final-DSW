<x-layout>
    ...
    <div class="capa">
        <p style="font-size: 25px; text-align: center; padding: 5px; margin: 5px">Formulário de confirmação de convidados <br><a href="/convidado/{{$reserva->id}}" target="_blank" style="color: gold"><b>Clique aqui</b></a></p>
    </div>
        <div>
